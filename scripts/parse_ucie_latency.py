...
LOG_FILE = Path("outputs/gem5_ucie_endpoint/logs/run.log")
OUT_CSV = Path("outputs/gem5_ucie_endpoint/results/ucie_latency_table.csv")
OUT_TXT = Path("outputs/gem5_ucie_endpoint/results/ucie_metrics_report.txt")
